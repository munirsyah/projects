<!-- Navbar-->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo anchor('c_direktur/laporan_profil/'.$row->id_pasien,'<i class="fa fa-fw fa-lg fa-file-pdf-o"></i> Detil Profil','target="_blank"'); ?></td>
                  </tr>
                </tbody>
                <?php $no++; } ?>
              </table>
          ...
          ?>
            <div class="card">
              <h3 class="card-title">Data Pasien tidak ditemukan</h3>
            </div>
