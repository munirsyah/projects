<!-- Navbar-->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
               <a href="<?= base_url('c_petugaspendaftaran/laporan_pasien'); ?>" class="btn btn-primary btn-md btn-circle pull-right" style="margin-bottom: 2%;" target="_blank"><i class="fa fa-print"></i> Laporan Pasien Berobat</a>
                  ...
                  <?php
                    if($berobat){
                      ...
                      foreach ($berobat as $row) {
                        ...
                        if ($row->tgl_berobat == $tanggalhariini){
                  ?>
                  <tr>
                    ...
                    <td><?php echo date("l, d-m-Y",strtotime($row->tgl_berobat)) ?></td>
                    <td><?php echo anchor('c_petugaspendaftaran/canceldaftar/'.$row->id_berobat,'<i class="fa fa-remove fa-lg"></i> Cancel Daftar', array('id' => 'konfirmasi','onclick'=>'if (!confirmcancelberobat('.$row->id_berobat.')) return false;')); ?></td>
                  </tr>
                  <?php
                      }
                    } }else{
                      echo '<tr><td colspan="8" align="center">Tidak ada data pasien yang mendaftar berobat</td></tr>';
                    }
                  ?>
                </tbody>
              </table>
