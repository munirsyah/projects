          ...
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">List Data Rinci Pasien</h3>
                <div class="row">
                    <div class="col-lg-12">
                        <form role="form" action="<?php echo base_url('c_petugaspendaftaran/cari_detil_pasien');?>" method="post">

                            <div class="form-group">
                                <label>Cari Data Berdasarkan Nama Pasien</label>
                                <input class="form-control" type="text" required placeholder="Cari Data Berdasarkan Nama Pasien" name="nama" oninvalid="this.setCustomValidity('Silahkan isi terlebih dahulu kolom pencarian')" oninput="setCustomValidity('')">
                            </div>
