<!-- Navbar-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-gears"></i> Kelola Data Pasien</h1>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
            <a href="<?= base_url('c_petugaspendaftaran/cetak_pasien'); ?>" class="btn btn-primary btn-md btn-circle pull-right" style="margin-bottom: 2%;" target="_blank"><i class="fa fa-print"></i> Print</a>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo anchor('c_petugaspendaftaran/edit_pasien/'.$row->id_pasien,'<i class="fa fa-edit fa-lg"></i>').' '.anchor('c_petugaspendaftaran/hapus_pasien/'.$row->id_pasien,'<i class="fa fa-close fa-lg"></i>', array('id' => 'konfirmasi','onclick'=>'if (!confirmhapuspasien('.$row->id_pasien.')) return false;')); ?></td>
                    </tr>
                    <?php
                      }
                    }else{
