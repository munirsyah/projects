              ...
              <div class="card-body">
                <form action="<?php echo base_url('c_petugaspendaftaran/simpan_pasien'); ?>" method="post" onsubmit="register()">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Nama Lengkap Pasien" autofocus name="nama" required oninvalid="this.setCustomValidity('Kolom Nama tidak boleh kosong')" oninput="setCustomValidity('')">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="animated-radio-button">
                        <label>
                          <input type="radio" value="Laki-laki" name="jk"><span class="label-text">Laki-laki</span>
                        </label>
                    </div>
                    <div class="animated-radio-button">
                        <label>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Kota Kelahiran" name="tempat" required oninvalid="this.setCustomValidity('Kolom Tempat Kelahiran tidak boleh kosong')" oninput="setCustomValidity('')">
                  </div>

                  <div class="form-group">
                    <label class="control-label">Tanggal Lahir</label>
                    <input class="form-control" id="demoDatePasien" type="text" placeholder="Tanggal Lahir" name="tanggal" required oninvalid="this.setCustomValidity('Kolom Tanggal Lahir tidak boleh kosong')" autocomplete="off">
                  </div>

                  <div class="form-group">
                    <label class="control-label">Alamat</label>
                    <textarea class="form-control" rows="4" placeholder="Alamat Lengkap Pasien" name="alamat" required oninvalid="this.setCustomValidity('Kolom Alamat tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
                  </div>

                  <div class="form-group">
                    <label class="col-lg-2 control-label" for="select">Golongan Darah</label>
                        <select class="form-control" id="select" name="goldar" required oninvalid="this.setCustomValidity('Kolom Golongan Darah tidak boleh kosong')" oninput="setCustomValidity('')">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="No. Telepon" pattern="[0-9]*" name="notelp" required title="Isi Kolom No. Telp. dengan angka">
                  </div>
                 ...
                 <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="animated-radio-button">
                        <label>
                          <input type="radio" value="Belum Menikah" name="status" required><span class="label-text"> Belum Menikah</span>
                        </label>
                    </div>
                    <div class="animated-radio-button">
                        <label>
                          <input type="radio" value="Menikah" name="status"><span class="label-text">
                          Menikah</span>
                        </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-lg-2 control-label" for="select">Pekerjaan</label>
                        <select class="form-control" id="select" name="pekerjaan" required oninvalid="this.setCustomValidity('Kolom Pekerjaan tidak boleh kosong')" oninput="setCustomValidity('')">
