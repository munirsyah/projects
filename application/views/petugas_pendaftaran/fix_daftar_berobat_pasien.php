<!-- Navbar-->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Form Pendaftaran Berobat</h3>
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="<?php echo base_url('c_petugaspendaftaran/daftar_berobat_pasien');?>" method="post" onsubmit="register()">
                        <?php
