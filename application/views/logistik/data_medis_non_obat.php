<!-- Navbar-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-stethoscope"></i> Kelola Data Barang </h1>
            <p> Staff Logistik</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Data Barang Jenis Medis non Obat</h3>
                <a href="<?= base_url('c_logistik/cetak_medis'); ?>" class="btn btn-primary btn-md btn-circle pull-right" style="margin-bottom: 2%;" target="_blank"><i class="fa fa-print"></i> Print</a>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped" id="sampleTable">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo $row->id_item_medis ?></td>
                                        ...
                                        <td align="Right"><?php echo number_format ($row->harga_jual_item_medis); ?></td>
