                    ...
                    <div class="col-lg-6">
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Tanggal Kadaluarsa" name="tanggal" value="<?php echo date_format(date_create($row->tglkadaluarsa_obat), "Y-m-d"); ?>" required >
                            </div>

                            <div class="form-group">
                              <label>Satuan</label>
                              <select class="form-control" name="satuan" required oninvalid="this.setCustomValidity('Kolom Satuan tidak boleh kosong')" oninput="setCustomValidity('')">
                                <option value="">-Pilih Satuan-</option>
                                <option <?= $row->satuan == 'Botol' ? 'selected' : ''; ?> value="Botol" >Botol</option>
                                <option <?= $row->satuan == 'Dus' ? 'selected' : ''; ?> value="Dus">Dus</option>
                                <option <?= $row->satuan == 'Sachet' ? 'selected' : ''; ?> value="Sachet">Sachet</option>
                                <option <?= $row->satuan == 'Strip' ? 'selected' : ''; ?> value="Strip">Strip</option>
                              </select>
                            </div>

                            <div class="form-group">
                                <label>Harga Jual</label>
                                <input class="form-control" type="number" required name="harga" step="1" min="50" max="5000000" value="<?php echo $row->hargajual_obat ?>" oninvalid="this.setCustomValidity('Kolom Harga Jual tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>
