<!-- Navbar-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-stethoscope"></i> Input Data Barang Jenis Medis non Obat</h1>
            <p> Staff Logistik</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Form Input Data Barang Jenis Medis non Obat</h3>
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="<?php echo base_url('c_logistik/simpan_item_non_obat');?>" method="post" onsubmit="register()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" required placeholder="Nama Item" name="nama" oninvalid="this.setCustomValidity('Kolom Nama Item tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>

                            <div class="form-group">
                                <label>Tanggal Kadaluarsa</label>
                                <input class="form-control" id="demoDate" type="text" placeholder="Tanggal Kadaluarsa" name="tanggal" required oninvalid="this.setCustomValidity('Kolom Tanggal tidak boleh kosong')" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Harga </label>
                                <input class="form-control" type="number" placeholder="Harga" required name="harga" step="1" min="50" max="5000000" oninvalid="this.setCustomValidity('Kolom Harga tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>

                            <div class="form-group">
                                <label>Kuantitas</label>
                                <input class="form-control" type="number" placeholder="Kuantitas Item" required name="kuantitas" step="1" min="0" max="100000" oninvalid="this.setCustomValidity('Kolom Kuantitas tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>
