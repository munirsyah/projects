          ...
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Data Barang Jenis Obat</h3>
                <a href="<?= base_url('c_logistik/input_penjualan'); ?>" class="btn btn-primary btn-md btn-circle pull-right" style="margin-bottom: 2%;" ><i class="fa fa-medkit"></i> penjualan obat</a>
                            ...
                            <table class="table table-hover table-striped" id="sampleTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"> <?php echo $row->jumlah_beli ?></td>
