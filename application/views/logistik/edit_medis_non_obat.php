<!-- Navbar-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-stethoscope"></i> Data Barang Jenis Medis non Obat</h1>
            <p> Staff Logistik</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Ubah Data Item Medis non Obat</h3>
                    ...
                    <div class="col-lg-6">
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Tanggal Kadaluarsa" name="tanggal" value="<?php echo date_format(date_create($row->tanggal_kadaluarsa_item_medis), "Y-m-d"); ?>" required >
                            </div>
