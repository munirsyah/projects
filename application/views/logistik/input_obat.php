<!-- Navbar-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-medkit"></i> Input Data Barang Jenis Obat</h1>
            <p> Staff Logistik</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Form Input Data Barang Jenis Obat</h3>
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="<?php echo base_url('c_logistik/simpan_obat');?>" method="post" onsubmit="register()">

                            <div class="form-group">
                                <label>Nama Obat</label>
                                <input class="form-control" type="text" required placeholder="Nama Obat" name="nama" oninvalid="this.setCustomValidity('Kolom Nama Obat tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>

                            <div class="form-group">
                                <label>Jenis Obat</label>
                                <select class="form-control" id="select" name="jenis" required oninvalid="this.setCustomValidity('Kolom Jenis Obat tidak boleh kosong')" oninput="setCustomValidity('')">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="demoDate" type="text" placeholder="Tanggal Kadaluarsa" name="tanggal" required oninvalid="this.setCustomValidity('Kolom Tanggal Kadaluarsa tidak boleh kosong')" autocomplete="off">
                            </div>

                            <div class="form-group">
                              <label>Satuan</label>
                              <select class="form-control" name="satuan" required oninvalid="this.setCustomValidity('Kolom Satuan tidak boleh kosong')">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" required name="harga" step="1" min="50" max="5000000" oninvalid="this.setCustomValidity('Kolom Harga Jual tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>

                            <div class="form-group">
                                <label>Stok</label>
                                <input class="form-control" type="number" required name="stok" step="1" min="0" max="100000" oninvalid="this.setCustomValidity('Kolom Stok tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div> 
