                    ...
                    <div class="col-lg-12">
                        <form role="form" action="<?php echo base_url('c_dokter/tampil_rekam_medis_pasien');?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" required placeholder="Cari Data Berdasarkan Nama Pasien" name="id" oninvalid="this.setCustomValidity('Silahkan isi terlebih dahulu kolom pencarian')" oninput="setCustomValidity('')">
                            </div>
