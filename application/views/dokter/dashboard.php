            ...
            <div class="card">
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <h3 class="panel-title">Dashboard Dokter Spesialis</h3>
                </div>
                <div class="panel-body"><p style="font-size: 22px;" align="center">Selamat Datang Dokter Klinik Restu Medika</p></div>
              </div>
            </div>
          </div>
        </div>
